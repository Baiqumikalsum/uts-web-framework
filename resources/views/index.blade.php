                ...
                <div class="row">
                                ...
                                <table class="table table-bordered mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $bgn->bagian }}</td>
                                            <td>
                                                <a href="/bagian/destroy/{{$bgn->id_bagian}}" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <table class="table table-bordered mt-5">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $jns->jenis_keb }}</td>
                                            <td>
                                                <a href="/jenis/destroy/{{$jns->id_jenisKeb}}" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                    ...
                    <div class="col">
                        <div class="card card-danger collapsed-card">
                            <div class="card-header">
                                <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#modaltam">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/index/destroy/{{$dt1->id_profile}}" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
